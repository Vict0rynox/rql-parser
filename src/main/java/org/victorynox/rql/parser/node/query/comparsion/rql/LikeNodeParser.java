 ...
 * @version 0.1
 */
public class LikeNodeParser extends AbstractRqlNodeParser {
	/**
	 * Default constructor
	 *
	 ...
	 */
	public LikeNodeParser(SubParserInterface<String> filedNameParser, SubParserInterface valueParser) {
